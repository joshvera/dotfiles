...
- Current working directory: string (e.g., "$HOME/github/dotfiles")
...
```json
{
  ...
  "repo_path": "$HOME/github/dotfiles",
...
payload='{"event_type":"idle-notification","repo_path":"$HOME/github/dotfiles","cwd":"$HOME/github/dotfiles","tmux_target":"main:0.0","tmux_session":"main","transcript_path":null,"permission_context":null,"timestamp":"2026-01-11T20:23:11Z"}'
