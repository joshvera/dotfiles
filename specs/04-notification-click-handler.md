...
~/.local/bin/notification-handler.sh \
  '{"repo_path":"/Users/vera/github/dotfiles","tmux_target":"main:0.0","tmux_session":"main"}'
# Expected: Ghostty focused, main:0.0 pane selected

# Test 2: Handler with missing session
~/.local/bin/notification-handler.sh \
  '{"repo_path":"/Users/vera/github/dotfiles","tmux_target":"deleted:0.0","tmux_session":"deleted"}'
# Expected: Ghostty focused, new "deleted" session created in /Users/vera/github/dotfiles

# Test 3: Handler with null tmux fields
~/.local/bin/notification-handler.sh \
  '{"repo_path":"/Users/vera/github/dotfiles","tmux_target":null,"tmux_session":null}'
